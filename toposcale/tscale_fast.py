...
download_sparse_dem(tmappSrc, wdir, pointsShp, demRes, pointsBuffer)
setup_sim_dirs(tmappSrc,wdir)
...
Parallel(n_jobs=int(num_cores))(delayed(compute_terrain)(tmappSrc,home, str(svfSectors), str(svfMaxDist)) for home in homes)
Parallel(n_jobs=int(num_cores))(delayed(make_listpoints)(tmappSrc,home, pointsShp) for home in homes)
...
Parallel(n_jobs=int(num_cores))(delayed(tscale3dmain)(mymonth) for mymonth in mymonths)
