...
dates = [str("1980-01-01"), str("2009-12-31")]
start = datetime.datetime.strptime(dates[0], "%Y-%m-%d")
end = datetime.datetime.strptime(dates[1], "%Y-%m-%d")


dateList = OrderedDict(((start + datetime.timedelta(_)).strftime(r"%Y-%m-%d"), None) for _ in xrange((end - start).days)).keys()
...
def main(coords,eraDir, outDir,start):
	...
	zp_file=eraDir+"/PLEV_geopotential_1980_test.nc"

	plevDict={
	eraDir+"/PLEV_temperature_1980_test.nc" : "t",
	eraDir+"/PLEV_u_component_of_wind_1980_test.nc": "u",
	eraDir+"/PLEV_v_component_of_wind_1980_test.nc": "v",
	eraDir+"/PLEV_relative_humidity_1980_test.nc" : "r"
	}

	surfDict={
	eraDir+"/SURF_2m_temperature_1980_test.nc" : "t2m",
	eraDir+"/SURF_2m_dewpoint_temperature_1980_test.nc": "d2m",
	eraDir+"/SURF_geopotential_1980_test.nc": "z",
	eraDir+"/SURF_surface_solar_radiation_downwards_1980_test.nc" : "ssrd",
	eraDir+"/SURF_surface_thermal_radiation_downwards_1980_test.nc" :"strd",
	eraDir+"/SURF_Total_precipitation_1980_test.nc" : "tp",
	eraDir+"/SURF_TOA_incident_solar_radiation_1980_test.nc": "tisr"
	}
	...
	#open
	f = nc.Dataset("tscale"+str(starti)+".nc",'w', format='NETCDF4')
	...
	t = f.createVariable('t',    'f4',('lon','time'))
	r = f.createVariable('r',    'f4',('lon','time'))	
	ws = f.createVariable('ws',    'f4',('lon','time'))
	wd = f.createVariable('wd',    'f4',('lon','time'))
	lwin = f.createVariable('lwin',    'f4',('lon','time'))
	swin = f.createVariable('swin',    'f4',('lon','time'))
	p = f.createVariable('p',    'f4',('lon','time'))
...
main(coords, eraDir, outDir, start )
