...
def retrieve_interim(startDate,endDate,eraDir, latNorth,latSouth,lonEast,lonWest):
    """      
...
if __name__ == "__main__":
    ...
    endDate    = sys.argv[2]
    eraDir     = sys.argv[3]
    latNorth    = str(float(sys.argv[4]))
    latSouth    =  str(float(sys.argv[5]))
    lonEast     = str(float(sys.argv[6]))
    lonWest     = str(float(sys.argv[7]))

    retrieve_interim(startDate,endDate,eraDir, latNorth,latSouth,lonEast,lonWest)
